...
<div class="mySlides fade" style="display: none;">
  ...
  <div class="text" style="color:black;">AWS DEEPRACER LEAGUE</div>
</div>

<div class="mySlides fade" style="display: none;">
  <div class="numbertext">2 / 5</div>
  <img src="IMG2.png" style="width:50%">
  <div class="text" style="color:blue;">AWS EDUCATE</div>
</div>
...
<div class="mySlides fade" style="display: none;">
  ...
  <div class="text" style="color:rgb(0, 17, 255);">MICROSOFT AZURE</div>
</div>

<div class="mySlides fade" style="display: none;">
  <div class="numbertext">5 / 5</div>
  <img src="IMG5.png" style="width:50%">
  <div class="text" style="color:rgb(0, 255, 128);">Microsoft Technology Associate (MTA)</div>
</div>
